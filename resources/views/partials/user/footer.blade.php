<footer class="w-full shadow m-2 mt-auto">
    <div class="w-full max-w-screen-xl mx-auto p-2 md:py-4">
        <div class="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0 md:space-x-2 rtl:space-x-reverse">
            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                <a href="https://flowbite.com/" class="flex items-center space-x-2 rtl:space-x-reverse">
                    <img src="https://img.logoipsum.com/249.svg" class="h-8" alt="Flowbite Logo" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Blog App</span>
                </a>
            </div>
            <ul class="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-2 rtl:space-x-reverse text-xs font-medium text-gray-500 dark:text-gray-400">
                <li>
        ...
        <span class="block text-xs text-gray-500 text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">Blog App</a>. All Rights Reserved.</span>
    </div>
</footer>
